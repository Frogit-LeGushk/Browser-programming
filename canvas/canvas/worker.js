addEventListener('message', ({data: {offscreenCanvas, theme, number}}) => {
    ...
    arrayOfBalls = new CreaterBalls(!theme, number).createBalls

    function draw() {

    requestAnimationFrame(draw)

    ctx.fillStyle = theme ? 'rgba(0, 0, 0, 0.35)' : 'rgba(255, 255, 255, 0.35)'
